...
type fillerRightsCurrentInput struct {
	SourceID           string `query:"sourceId" maxLength:"256"`
	AcquisitionID      string `query:"acquisitionId" maxLength:"256"`
	SourceMasterSHA256 string `query:"sourceMasterSha256" minLength:"64" maxLength:"64"`
	PolicySHA256       string `query:"policySha256" minLength:"64" maxLength:"64"`
}
