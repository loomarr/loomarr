...
var testServerConstructors = map[string]string{
	...
	"guide_test.go:newGridServer":                                      "guide grid",
	"guide_test.go:newGridServerWithArtwork":                           "guide artwork",
	"guide_test.go:newGridServerWithConfig":                            "guide configuration",
	"guide_test.go:newGridServerWithPods":                              "guide pods",
	...
	"playout_test.go:newPlayoutServer":                                 "playout",
	"playoutguide_test.go:newGuideServer":                              "playout guide",
	"playoutprogram_test.go:newProgramServer":                          "playout program",
	"pods_test.go:newPodsServer":                                       "filler pods",
	"proposaljourneys_test.go:proposalJourneyServer":                   "proposal journeys",
	"proposals_test.go:newSuggestServer":                               "proposals",
	"proposals_test.go:newSuggestServerWithSettings":                   "proposal settings",
	"proposals_test.go:newSuggestServerWithSettingsAndDecisionQuality": "proposal decision quality",
