...
func newDashboardHarness(t *testing.T, sessions api.PlayoutObserver) *dashboardHarness {
	t.Helper()
	...
	return &dashboardHarness{apiHarness: base}
}
...
func TestPlayoutTelemetry_RequiresAdmin(t *testing.T) {
	srv := newDashboardHarness(t, &fakePlayoutSessions{}).Server
...
func TestPlayoutTelemetry_ReportsSessionsAndLoad(t *testing.T) {
	srv := newDashboardHarness(t, &fakePlayoutSessions{
		capacity: 4,
...
func TestPlayoutTelemetry_UnwiredIsNotRunning(t *testing.T) {
	srv := newDashboardHarness(t, nil).Server
...
func TestPlayoutTelemetry_RunningWithNoStreams(t *testing.T) {
	srv := newDashboardHarness(t, &fakePlayoutSessions{capacity: 4}).Server
