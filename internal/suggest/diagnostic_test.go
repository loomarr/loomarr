...
func TestRunToolFinalizationDiagnosticUsesFrozenPostResultContract(t *testing.T) {
	...
	if report.PromptVersion != "suggester-prompt-v8" || report.ToolSchemaVersion != "catalog-search-v6" || report.MessageTemplateVersion != "planner-tool-result-finalization-v3" {
