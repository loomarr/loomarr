...
func TestRunToolFinalizationDiagnosticUsesFrozenPostResultContract(t *testing.T) {
	...
	if report.PromptVersion != "suggester-prompt-v10" || report.ToolSchemaVersion != "catalog-search-v6" || report.MessageTemplateVersion != "planner-tool-result-finalization-v3" {
	...
	if report.SystemPromptSHA256 != "3818a5fd969b40a5a57510f7aa5fdb56bc134d03acb3b78b32f52ada75bf5478" ||
		...
		report.MessagesSHA256 != "e8e7dfd0d37912c3f5cd6a6bcb9ea3cab16b7bbd1839e9e5b367cfff88f6f9a3" ||
