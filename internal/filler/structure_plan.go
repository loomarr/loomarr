...
func buildStructurePlan(durationMs int64, boundaries []StructureBoundary, claims []StructureRoleClaim, discards []StructureDiscardClaim, observations []StructureObservation) ([]StructurePlanSegment, error) {
	...
	knownEvidence := make(map[string]struct{}, len(observations))
	for _, o := range observations {
		knownEvidence[o.ID] = struct{}{}
	}
