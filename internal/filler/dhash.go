...
// a 9x8 grayscale frame, left-greater-than-right bits, and aligned-prefix comparison. A future
// change gets a new key rather than interpreting old persisted evidence under new semantics.
