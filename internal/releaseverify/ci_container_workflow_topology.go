...
func workflowTopologyAuthorityEntries() map[string]workflowTopologyAuthority {
	return map[string]workflowTopologyAuthority{
		"android-beta.yml":            {jobs: map[string]int{"release": 14}},
		...
		"ci-expo-android-mobile.yml":  {jobs: map[string]int{"run": 11}},
		"ci-expo-android-tv.yml":      {jobs: map[string]int{"run": 11}},
		...
		"ci.yml": {jobs: map[string]int{
			...
			"store-postgres": 0, "frontend": 0, "clients": 0, "apple-mobile": 0, "apple-tv": 0, "apple-cache-validation": 0, "expo-android-mobile": 0, "expo-android-tv": 0,
...
func reusableWorkflowCallerAuthorityEntries() map[string]reusableWorkflowCallerAuthority {
	return map[string]reusableWorkflowCallerAuthority{
		...
		"expo-android-tv":     {name: "Expo Android TV — native build", condition: "needs.changes.outputs.impact_expo_android_tv == 'true'"},
