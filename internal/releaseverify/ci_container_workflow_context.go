...
func workflowJobContextAuthorityEntries() map[workflowJobContextKey]workflowJobContextAuthority {
	return map[workflowJobContextKey]workflowJobContextAuthority{
		...
		{workflow: "ci-apple-mobile.yml", job: "run"}:        {name: "Apple mobile — native build + launch", runsOn: "macos-26"},
		{workflow: "ci-apple-tv.yml", job: "run"}:            {name: "Apple TV — native build + launch", runsOn: "macos-26"},
