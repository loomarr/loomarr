...
func workflowActionAuthorityEntries() map[workflowActionKey]string {
	return map[workflowActionKey]string{
		...
		{workflow: "ci-apple-mobile.yml", job: "run", step: 3}:              `{"name":"Cache pnpm and CocoaPods work","uses":"actions/cache@55cc8345863c7cc4c66a329aec7e433d2d1c52a9","with":{"path":"~/.local/share/pnpm/store\n~/Library/Caches/CocoaPods\n","key":"apple-clients-mobile-${{ runner.os }}-${{ hashFiles('web/pnpm-lock.yaml') }}","restore-keys":"apple-clients-mobile-${{ runner.os }}-"}}`,
		...
		{workflow: "ci-apple-mobile.yml", job: "run", step: 8}:              `{"name":"Cache ExpoModulesJSI native slice","uses":"actions/cache@55cc8345863c7cc4c66a329aec7e433d2d1c52a9","with":{"path":"web/node_modules/.pnpm/expo-modules-jsi@*/node_modules/expo-modules-jsi/apple/Products","key":"apple-jsi-mobile-${{ runner.arch }}-${{ steps.apple-toolchain.outputs.fingerprint }}-${{ hashFiles('web/pnpm-lock.yaml') }}","restore-keys":"apple-jsi-mobile-${{ runner.arch }}-${{ steps.apple-toolchain.outputs.fingerprint }}-"}}`,
		...
		{workflow: "ci-apple-tv.yml", job: "run", step: 3}:                  `{"name":"Cache pnpm and CocoaPods work","uses":"actions/cache@55cc8345863c7cc4c66a329aec7e433d2d1c52a9","with":{"path":"~/.local/share/pnpm/store\n~/Library/Caches/CocoaPods\n","key":"apple-clients-tv-${{ runner.os }}-${{ hashFiles('web/pnpm-lock.yaml') }}","restore-keys":"apple-clients-tv-${{ runner.os }}-"}}`,
		...
		{workflow: "ci-apple-tv.yml", job: "run", step: 8}:                  `{"name":"Cache ExpoModulesJSI native slice","uses":"actions/cache@55cc8345863c7cc4c66a329aec7e433d2d1c52a9","with":{"path":"web/node_modules/.pnpm/expo-modules-jsi@*/node_modules/expo-modules-jsi/apple/Products","key":"apple-jsi-tv-${{ runner.arch }}-${{ steps.apple-toolchain.outputs.fingerprint }}-${{ hashFiles('web/pnpm-lock.yaml') }}","restore-keys":"apple-jsi-tv-${{ runner.arch }}-${{ steps.apple-toolchain.outputs.fingerprint }}-"}}`,
