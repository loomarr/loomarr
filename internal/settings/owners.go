...
var fillerOwners = map[string]Owner{
	...
	"filler.research.wikidata_enabled":  OwnerFillerDetails,
	"filler.research.wikipedia_enabled": OwnerFillerDetails,
	"filler.research.archive_enabled":   OwnerFillerDetails,
	"filler.research.loc_enabled":       OwnerFillerDetails,
