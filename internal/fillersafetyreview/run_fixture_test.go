...
func newReviewFixture(t *testing.T, baseURL string) reviewFixture {
	...
	positiveSlices := []string{
		...
		fillersafetycert.SliceMusicOverlap, fillersafetycert.SlicePartialToken,
		fillersafetycert.SlicePhoneticConfusable, fillersafetycert.SliceQuietSpeech,
...
func (fixture reviewFixture) runtime(client *http.Client, baseURL string) reviewRuntime {
	return reviewRuntime{
		...
		call: openroutermedia.Call, extract: fakeAudioExtractor{},
...
func (fakeAudioExtractor) Extract(context.Context, string, *fillersafety.CompleteMediaPlan, int64) ([]byte, error) {
