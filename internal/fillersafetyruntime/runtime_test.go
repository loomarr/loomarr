...
func (r *runtimeRepository) FindSpokenSafetyRun(context.Context, string) (fillersafety.LedgerRun, bool, error) {
	return r.run, r.found, nil
}
func (*runtimeRepository) BeginSpokenSafetyRun(context.Context, fillersafety.LedgerRun) (bool, error) {
	return true, nil
}
func (*runtimeRepository) AppendSpokenSafetyEvent(context.Context, fillersafety.LedgerEvent) error {
	return nil
}
func (*runtimeRepository) ListSpokenSafetyEvents(context.Context, string) ([]fillersafety.LedgerEvent, error) {
	return nil, nil
}
func (*runtimeRepository) ReserveSpokenSafetyCall(context.Context, fillersafety.HostedCallReservation) (fillersafety.LedgerEvent, error) {
	return fillersafety.LedgerEvent{}, nil
}
func (*runtimeRepository) SettleSpokenSafetyCall(context.Context, fillersafety.HostedCallSettlement) (fillersafety.LedgerEvent, error) {
	return fillersafety.LedgerEvent{}, nil
}
...
type capturingOperation struct {
	requests []fillersafety.EvaluationRequest
}

func (o *capturingOperation) Evaluate(_ context.Context, request fillersafety.EvaluationRequest) (fillersafety.EvaluationReport, error) {
...
func TestRuntimeBuildsExactSourceAuthorityAndReusesDurableRunTime(t *testing.T) {
	...
	if report.Run.ID != fixture.request.OperationSHA256 || len(fixture.operation.requests) != 1 || fixture.snapshotCalls != 1 {
		t.Fatalf("report=%+v requests=%d snapshots=%d", report, len(fixture.operation.requests), fixture.snapshotCalls)
	}
	...
	first := fixture.operation.requests[0]
	...
	fixture.repository.run = fillersafety.LedgerRun{ID: fixture.request.OperationSHA256, CreatedAt: durableAt}
	...
	if len(fixture.operation.requests) != 2 || fixture.snapshotCalls != 1 ||
		fixture.operation.requests[1].StartedAt != durableAt ||
		fixture.operation.requests[1].Source.Authority.MeasuredAt != durableAt || fixture.inspector.calls != 2 {
		t.Fatalf("retry request=%+v snapshots=%d inspections=%d", fixture.operation.requests[1], fixture.snapshotCalls, fixture.inspector.calls)
	}
}
...
func TestRuntimeRejectsRouteAndMediaDriftBeforeOperation(t *testing.T) {
	t.Run("capability", func(t *testing.T) {
		...
		if len(fixture.operation.requests) != 0 {
	...
	t.Run("duration", func(t *testing.T) {
		...
		if fixture.snapshotCalls != 0 || len(fixture.operation.requests) != 0 {
