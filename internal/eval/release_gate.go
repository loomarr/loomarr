...
const releaseGateManifestPath = "testdata/planner-release-gate-v3.json"

//go:embed testdata/planner-release-gate-v1.json testdata/planner-release-gate-v2.json testdata/planner-release-gate-v3.json testdata/planner-release-catalog-v1.json testdata/planner-release-sources-v1.json
