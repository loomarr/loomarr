...
const queryExpansionManifest = "testdata/query-expansion-v4.json"
...
func QueryExpansionRunnerConfig(config RunnerConfig) (RunnerConfig, error) {
	return queryDevelopmentRunnerConfig(queryExpansionManifest, "query-expansion-scorer-v4", config)
}
