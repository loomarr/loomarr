...
ALTER TABLE filler_clip_pipeline ADD COLUMN preparation_started_at BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE filler_clip_pipeline ADD COLUMN stage_queued_at BIGINT NOT NULL DEFAULT 0;
ALTER TABLE filler_clip_pipeline ADD COLUMN stage_started_at BIGINT NOT NULL DEFAULT 0;
