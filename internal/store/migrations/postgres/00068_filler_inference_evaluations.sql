-- +goose Up
-- V62 (§10). Postgres mirror of sqlite 00068; the full reasoning lives there.
...
CREATE TABLE IF NOT EXISTS filler_inference_evaluations (
  ...
  derivative_duration_ms BIGINT NOT NULL DEFAULT 0,
  derivative_pixels     BIGINT NOT NULL DEFAULT 0,
  ...
  charged_nano_usd      BIGINT NOT NULL DEFAULT 0,
  estimated_nano_usd    BIGINT NOT NULL DEFAULT 0,
