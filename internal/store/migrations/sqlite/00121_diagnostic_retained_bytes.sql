...
DROP INDEX idx_diagnostic_events_source_time;
DROP INDEX idx_diagnostic_events_instance;

DROP INDEX idx_diagnostic_events_request;
DROP INDEX idx_diagnostic_events_playback;
DROP INDEX idx_diagnostic_events_channel;
DROP INDEX idx_diagnostic_events_schedule_block;
DROP INDEX idx_diagnostic_events_job;
DROP INDEX idx_diagnostic_events_process;
