-- +goose Up
-- V54c (§10): persisted derived fingerprints for compilation de-duplication.
--
...
-- foreign key; catalog pruning removes orphans. The content hash invalidates changed bytes and
-- the algorithm key invalidates detector changes.
