...
func fillerReindexJob(j *filler.ReindexJob) scheduler.Job {
	return scheduler.Job{
		Name: "filler-reindex", Group: scheduler.GroupFiller, Title: "Reindex filler tags",
		Description: "Recomputes clip tags from the current taxonomy after its categories change.",
