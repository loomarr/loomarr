...
disagreement, insufficient coverage, or operational failure remains held. A
negative decision means only `candidate_rejected`; it does not mean clean,
suitable, ingestible, or schedulable.
