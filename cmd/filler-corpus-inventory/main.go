// Command filler-corpus-inventory deterministically combines strict schema-v4
...
func run(args []string, stdout, stderr io.Writer) int {
	...
	var inputs paths
	flags.Var(&inputs, "inventory", "strict schema-v4 source inventory; repeat for every capture file")
