// Command filler-corpus-inventory deterministically combines strict schema-v5
...
func run(args []string, stdout, stderr io.Writer) int {
	...
	var inputs paths
	flags.Var(&inputs, "inventory", "strict schema-v5 source inventory; repeat for every capture file")
