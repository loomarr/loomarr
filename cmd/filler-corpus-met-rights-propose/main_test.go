...
func TestRunPublishesPrivateNonAuthorizingReportAndRefusesOverwrite(t *testing.T) {
	...
	inventory := fillercorpus.Inventory{
		...
		Cases: []fillercorpus.InventoryCase{{
			...
			Representation: fillercorpus.InventoryRepresentation{Transport: fillercorpus.TransportHTTPS, Name: "valid.jpg", URL: "https://images.metmuseum.org/valid.jpg", MIMEType: "image/jpeg", Bytes: 100},
		}},
	}
