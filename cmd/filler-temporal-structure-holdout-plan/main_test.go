...
func TestRunRequiresEveryFrozenAuthority(t *testing.T) {
	...
	for _, required := range []string{
		...
		"suitability", "reference audit", "reference download ledger", "families", "transitions", "programmes", "source root", "private seed", "lineage mode", "fixed planning time", "output",
	} {
