...
controller and authoritative Surf journey wired to the production native shells. Explicit TV focus
binding, SSE reconciliation, diagnostics, populated artwork evidence, and real-device acceptance
remain open.
