...
- Status: shipped and archived on 2026-08-18
...
This is the historical ship contract for the first public beta. For current work, use
`PROGRESS.md`; for published artifacts and notes, use
[GitHub Releases](https://github.com/loomarr/loomarr/releases).
...
| Distribution | A pinned `ghcr.io/loomarr/loomarr:<beta>` image installs and upgrades through the documented Compose path. Both release architectures build before tagging. Prereleases do not move `latest`. |
