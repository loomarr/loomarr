...
| `asr.url` (`ASR_URL`) | AI | url | — | OpenAI-compatible speech-to-text API base, such as http://ai-server:8083/v1. Leave blank to reuse the active hosted AI service. _(advanced)_ |
