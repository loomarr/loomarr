...
| `filler.pipeline.max_split_vision` (`FILLER_PIPELINE_MAX_SPLIT_VISION`) | int | `60` | How many segments of one recording Loomarr looks at before deciding whether it can cut it automatically. Recordings with more segments than this always wait for you. _(advanced)_ |
