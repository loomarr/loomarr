...
parameters. A same-element replacement transfers the controller's open MediaSource and compatible
SourceBuffers, then clears their old ranges before the independent Channel timeline attaches; if that
