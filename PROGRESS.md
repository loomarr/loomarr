...
**Active phase: 9 — Users & auth.** Phases 0–8 done (see the phase table). Phase 9 fills the auth
seam (`api.Authorizer`) with session-cookie auth and should capture the real Emby login-success
body (deferred from Phase 0/5).
