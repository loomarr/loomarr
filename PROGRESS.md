...
**Active phase: 10 — Scheduler + Tunarr (the point of the app).** Phases 0–9 done (see the phase
table). Phase 10 builds against the vendored Tunarr spec + dev-Tunarr (`tunarr-dev`, wired to
Emby); remember the **server-assigns-channel-id** finding (Phase 0).
