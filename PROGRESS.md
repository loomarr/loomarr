...
**Next up:** the remaining v2 phases — **V8** (SSO as a credential path) and the audit
leftovers (`scope.collections`, blocked on a missing endpoint to list media-server
