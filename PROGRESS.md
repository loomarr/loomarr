...
**Next up: the Filler track** (2026-07-31) — the v2 plan's `### Filler` table, of which V17a and
V28 shipped and **six phases remain**: V17b, V17c, V17d, V29a/b, V30, V33. Claimed and in
progress across two worktrees; the lane split and the corrected dependency graph are
`docs/engineering/v2-build-plan.md` §6.2.
