...
**Next up:** **V10** (all-settings search — now unblocked, and "All settings" exists to be
searched), **V12** (System → Backup + About), **V13** (restart control + probes), or **V31/V32**
(Dashboard Services panel and activity feed, unblocked by V16's shell). Audit leftovers:
`scope.collections` is blocked on a **missing endpoint** (nothing lists media-server
