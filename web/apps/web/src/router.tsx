...
import { Layout, Placeholder } from "@/routes";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "channels",
        element: <Placeholder title="Channels" hint="No channels yet — create your first from an intent." />,
      },
      {
        path: "board",
        element: (
          <Placeholder
            title="Board"
            hint="Nothing in flight — approved acquisitions show their journey here."
          />
        ),
      },
      {
        ...
        element: (
          <Placeholder
            title="Suggest"
            hint="Describe a channel and Loomarr grounds a lineup against your library."
          />
        ),
      },
      {
      ...
      {
        path: "users",
        element: <Placeholder title="Users" hint="Import Emby/Jellyfin accounts to let them sign in." />,
      },
      {
        path: "settings",
        element: (
