...
const AccountScreen = () => {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      <PageHeader
        title="Your account"
        description="Your sign-in, your password, and the devices holding a session."
      />

      <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-4 overflow-auto p-6">
