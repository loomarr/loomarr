...
//   -hls_time 1 -hls_segment_type fmp4 -hls_flags independent_segments -hls_playlist_type vod
          ...
          asset[2] === "init.mp4"
            ...
            : asset[2] === "segment.m4s"
              ? asset[1] === channelId(1)
                ...
                : LONG_MEDIA_FRAGMENT
              : LIVE_MEDIA_FRAGMENTS[asset[2] as keyof typeof LIVE_MEDIA_FRAGMENTS];
        if (!bytes) return sendJSON(response, { title: "Not found" }, 404);
