...
# The seven literal lanes live in ci-go.yml's `matrix.lane`; see scripts/go-test-lane.sh.
#
...
# identities plus its certification identity, so execution and coverage authority cannot drift.
